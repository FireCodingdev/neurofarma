...
export function RelatorioForm({ relatorio }: RelatorioFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = isEdit
        ? `/api/admin/relatorios/${relatorio!.id}`
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        ...
        <p className="text-xs text-neutral-400 mb-4">
          Suporta HTML básico: use <code className="bg-neutral-100 px-1 rounded">&lt;p&gt;</code>, <code className="bg-neutral-100 px-1 rounded">&lt;strong&gt;</code>, <code className="bg-neutral-100 px-1 rounded">&lt;h2&gt;</code>, <code className="bg-neutral-100 px-1 rounded">&lt;ul&gt;</code>&lt;li&gt;, etc.
        </p>
        <textarea
          value={form.corpo}
      ...
      <Card>
        <h2 className="font-semibold text-neutral-900 mb-5">Publicação</h2>
        <div className="space-y-4">
          <div>
      ...
      <div className="flex items-center gap-4">
        <Button type="submit" size="lg" disabled={statusReq === 'loading' || statusReq === 'success'}>
          {statusReq === 'loading' ? (
            'Salvando...'
          ) : statusReq === 'success' ? (
