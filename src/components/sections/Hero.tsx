          ...
          <div className="flex flex-col items-start">
            ...
            <div className="mt-14 grid grid-cols-3 gap-4 w-full animate-fade-in" style={{ animationDelay: '0.4s' }}>
              {[
                ...
                <div key={label} className="flex flex-col items-center gap-2 p-4 rounded-2xl bg-white/5 border border-white/10 text-center">
                  <Icon className="w-6 h-6 text-primary-400" />
                  <span className="text-lg font-display font-bold text-white leading-tight">{label}</span>
